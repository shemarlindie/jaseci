...
sed -i "s/JaseciAIService/${CamelCaseName}" ${SnakeCaseName}/${SnakeCaseName}.py
sed -i "s/jaseci-ai-service/${DashName}" ${SnakeCaseName}/${SnakeCaseName}.yaml
sed -i "s/jaseci_ai_service/${SnakeCaseName}" ${SnakeCaseName}/${SnakeCaseName}.yaml
sed -i "s/JaseciAIService/${CamelCaseName}" ${SnakeCaseName}/${SnakeCaseName}.yaml
